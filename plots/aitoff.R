...
gal<-read.table("../../tempel_limpio.dat")
...
createAllSkyGridChart(longitude = c(0, 45, 90, 135, 180, 225, 270, 315, 360),
		      ...
		      label.cex = 0.6, main = NULL)
#galaxias tempel
overplotScatterPlotInAllSkyGridChart(rac_gxs, dec_gxs, pointcol = 'grey78', # azure4
				     dataCoordSys = "equatorial",
				     mainGrid = "equatorial",
                                     projname = "aitoff", projparam = NULL, 
				     pch='.',pointsize =0.01)
